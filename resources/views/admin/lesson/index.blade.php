...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 课程管理 <span class="c-gray en">&gt;</span> 管理员列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tr class="text-c">
			...
			<th width="40">ID</th>
			<th width="150">点播课程名称</th>
			<th width="90">所属课程</th>
			<th width="200">视频时长</th>
			<th width="200">播放</th>
			<th width="50">排序</th>
		...
		<tr class="text-c">
			...
			<td>{{$v->video_time}}</td>
			<td><a href="javascript:;" onclick="video_play('{{$v->lesson_name}}','/admin/lesson/play?id={{$v->id}}','800','500')" class="btn btn-primary radius" style="text-decoration:none">
					<i class="Hui-iconfont">&#xe6e6;</i>播放</a></td>
			<td>{{$v->sort}}</td>
			<td>{{$v->created_at}}</td>
			@if($v->status == '2')
